resource "yandex_kubernetes_cluster" "this" {
  ...
  service_account_id       = var.default_service_account == true ? module.master_sa[0].this.id : var.service_account_id
  node_service_account_id  = var.default_node_service_account == true ? module.node_sa[0].this.id : var.node_service_account_id
