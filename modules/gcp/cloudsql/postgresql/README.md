# Copied from https://github.com/terraform-google-modules/terraform-google-sql-db/tree/main/modules/postgresql
...
## Usage
Functional examples are included in the [examples](https://github.com/terraform-google-modules/terraform-google-sql-db/tree/main/examples) directory. If you want to create an instance with failover replica and manage lifecycle of primary and secondary instance lifecycle using this module follow example in [postgresql-with-cross-region-failover](https://github.com/terraform-google-modules/terraform-google-sql-db/tree/main/examples/postgresql-with-cross-region-failover/)
